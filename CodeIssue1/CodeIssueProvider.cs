...
namespace RefactoringIssues
{
    ...
    class CodeIssueProvider : ICodeIssueProvider
    {
        ...
        [Import]
        private IWorkspaceDiscoveryService workspaceDiscoveryService { set; get; }
        ...
        public CodeIssueProvider(ICodeActionEditFactory editFactory)
        {
            ...
            // get the log
            logger = NLoggerUtil.getNLogger(typeof (CodeIssueProvider));
        }
        ...
        public IEnumerable<CodeIssue> GetIssues(IDocument document, CommonSyntaxNode node, CancellationToken cancellationToken)
        {
            ...
            GhostFactorComponents.HistoryComponent.Enqueue(document);
        ...
        private void retrieveService(IDocument document, bool show)
        {
            ...
            instance.WorkspaceDiscoveryService = workspaceDiscoveryService;
